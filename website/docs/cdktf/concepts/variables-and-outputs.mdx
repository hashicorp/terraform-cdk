...
- CLI argument: `cdktf deploy --var='imageId=ami-abcde123'`
- Auto-loaded configuration files: Refer to the [Terraform documentation](https://www.terraform.io/docs/configuration/variables.html#variable-definitions-tfvars-files) for details.
