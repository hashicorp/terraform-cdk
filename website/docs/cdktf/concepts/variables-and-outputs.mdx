...
You can pass input variables e.g. with the name `imageId` to CDKTF in the following ways:

- Environment variable: `TF_VAR_imageId=ami-abcde123`
- CLI argument: `cdktf deploy --var='imageId=ami-abcde123'` or `cdktf diff --var='imageId=ami-abcde123'` or `cdktf destroy --var='imageId=ami-abcde123'`
- Auto-Loaded Configuration files: See [Terraform documentation](https://www.terraform.io/docs/configuration/variables.html#variable-definitions-tfvars-files) for details.
