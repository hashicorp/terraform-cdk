...
func newMyStack(scope construct, id *string) *myStack {
	...
	imageId := cdktf.NewTerraformVariable(this, jsii.String("imageId"), &terraformVariableConfig{
...
func newMyStack(scope construct, id *string) *myStack {
	...
	aws.Ec2.NewInstance(this, jsii.String("example"), &instanceConfig{
		tags: commonTags.expression,
	})
	return this
}
...
func newMyStack(scope construct, name *string, props myStackProps) *myStack {
	...
	cdktf.NewTerraformOutput(this, jsii.String("my-domain"), &terraformOutputConfig{
		value: myDomain,
	})
	return this
}
...
func newMyStack(scope construct, name *string) *myStack {
	...
	random.NewRandomProvider(this, jsii.String("random"), &randomProviderConfig{
	})
	pet := random.NewPet(this, jsii.String("pet"), &petConfig{
	})

	cdktf.NewTerraformOutput(this, jsii.String("random-pet"), &terraformOutputConfig{
		value: pet.id,
	})
	return this
}
...
func newConsumer(scope construct, name *string) *consumer {
	...
	remoteState := cdktf.NewDataTerraformRemoteState(this, jsii.String("remote-pet"), &dataTerraformRemoteStateRemoteConfig{
		organization: jsii.String("hashicorp"),
		workspaces: map[string]*string{
			"name": jsii.String("producer"),
		},
	...
	cdktf.NewTerraformOutput(this, jsii.String("random-remote-pet"), &terraformOutputConfig{
