...
func newMyStack(scope construct, name *string) *myStack {
	...
	bucket := aws.S3.NewS3Bucket(this, jsii.String("bucket"), &s3BucketConfig{
		bucket: jsii.String("demo"),
	})

	asset := cdktf.NewTerraformAsset(this, jsii.String("lambda-asset"), &terraformAssetConfig{
		path: path.resolve(__dirname, jsii.String("../lambda")),
		type: cdktf.AssetType_ARCHIVE,
	})

	aws.S3.NewS3BucketObject(this, jsii.String("lambda-archive"), &s3BucketObjectConfig{
		bucket: bucket.bucket,
		key: asset.fileName,
		source: asset.path,
	})
