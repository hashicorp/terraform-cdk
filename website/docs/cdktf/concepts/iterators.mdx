...
- `iterator.mapToKey()`: Results in equivalent of `[for k, v in var.iteratorSource : k]`.
- `iterator.mapToValue()`: Results in equivalent of `[for k, v in var.iteratorSource : v]`.
- `iterator.mapToValueProperty("foo")`: Results in equivalent of `[for k, v in var.iteratorSource : v.foo]`.
