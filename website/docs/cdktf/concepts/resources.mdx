...
You can need to use snake cased keys inside of the `any` object together with the object syntax of your language of choice. Alternatively you can also use the escape hatch syntax to set the value.

<!-- #NEXT_CODE_BLOCK_SOURCE:ts examples/typescript/documentation#skipped-attributes -->
<!-- #NEXT_CODE_BLOCK_SOURCE:python examples/python/documentation#skipped-attributes -->
<!-- #NEXT_CODE_BLOCK_SOURCE:java examples/java/documentation#skipped-attributes -->
<!-- #NEXT_CODE_BLOCK_SOURCE:csharp examples/csharp/documentation#skipped-attributes -->
<!-- #NEXT_CODE_BLOCK_SOURCE:go examples/go/documentation#skipped-attributes -->
