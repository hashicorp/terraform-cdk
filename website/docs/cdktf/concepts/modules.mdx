...
import imports.terraform_aws_modules.aws;
...
using terraform_aws_modules.aws;
...
import awsVpc "github.com/myorg/myproject/generated/terraoform_aws_modules/aws"
...
func NewMyStack(scope construct, id *string) *myStack {
	...
	awsVpc.NewVpcModule(this, jsii.String("MyVpc"), &awsVpc.vpcProps{
...
# This module can come from a registry or through a local / remote reference
from my_constructs import MyLocalModule
...
// This module can come from a registry or through a local / remote reference
import com.mycompany.app.MyLocalModule;
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	localModule := myconstructs.NewMyLocalModule(this, jsii.String("local-module"), map[string]*string{
		"ipAddress": jsii.String("127.0.0.1"),
	})

	cdktf.NewTerraformOutput(this, jsii.String("dns-server"), &cdktf.TerraformOutputConfig{
		value: localModule.dnsServerOutput,
	})
	return this
}
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	provider := aws.NewAwsProvider(this, jsii.String("provider"), &aws.AwsProviderConfig{
		region: jsii.String("us-east-1"),
	})

	module := cdktf.NewTerraformHclModule(this, jsii.String("Vpc"), &cdktf.TerraformHclModuleOptions{
	...
	cdktf.NewTerraformOutput(this, jsii.String("vpc_id"), &cdktf.TerraformOutputConfig{
		value: module.get(jsii.String("vpc_id")),
	})

	cdktf.NewTerraformOutput(this, jsii.String("public_subnets_cidr_blocks"), &cdktf.TerraformOutputConfig{
