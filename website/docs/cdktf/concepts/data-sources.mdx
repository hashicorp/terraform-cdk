...
func NewHelloTerraform(scope construct, id *string) *HelloTerraform {
	...
	remoteState := cdktf.NewDataTerraformRemoteState(this, jsii.String("remote_state"), &dataTerraformRemoteStateRemoteConfig{
	...
	#error#.NewInstance(this, jsii.String("foo"), &instanceConfig{
