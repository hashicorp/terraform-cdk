...
func newMyStack(scope construct, name *string) *myStack {
	...
	random.NewRandomProvider(this, jsii.String("default"), &randomProviderConfig{
	})
	petNameLength := cdktf.NewTerraformVariable(this, jsii.String("petNameLength"), &terraformVariableConfig{
		type: jsii.String("number"),
		default: jsii.Number(2),
		description: jsii.String("Pet name length"),
	})

	myPet := random.NewPet(this, jsii.String("example"), &petConfig{
		length: petNameLength.value,
	})

	cdktf.NewTerraformOutput(this, jsii.String("name"), &terraformOutputConfig{
		value: myPet.id,
	})
	return this
}
