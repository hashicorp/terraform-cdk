...
For example, for a stack called `hello-terraform`, you would store this file in `cdktf.out/stacks/hello-terraform`. This directory contains the synthesized code that can be generated by running `cdktf synth` in
...
TODO: Please explain the actual method that you call and how you use it. Then, we can have these examples. Is it just .addOverride on the object where you need to override the default behavior? What arguments does it support?
