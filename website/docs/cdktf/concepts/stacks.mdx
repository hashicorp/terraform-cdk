...
from jsii_workbench.core import DockerBackend
...
import workbench.jsii.danielmschmidt.com.DockerBackend;
...
func newVPCStack(scope construct, id *string, region ) *vPCStack {
	...
	this.vpc = jsiiworkbench.NewMyAwsVpc(this, jsii.String("vpc"), map[string]interface{}{
	})
	return this
}
...
func newBackendStack(scope construct, id *string, config backendStackConfig) *backendStack {
	...
	jsiiworkbench.NewDockerBackend(this, jsii.String("docker-backend"), map[string]*string{
...
NewBackendStack(app, jsii.String("target-stack"), &backendStackConfig{
	region: origin.region,
	vpcId: origin.vpc.id,
