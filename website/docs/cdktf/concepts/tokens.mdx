...
from my_constructs import EksCluster
...
import com.mycompany.app.EksCluster;
...
func newMyStack(scope construct, id *string) *myStack {
	...
	logRetention := cdktf.NewTerraformVariable(this, jsii.String("logRetentionInDays"), &cdktf.terraformVariableConfig{
		type: jsii.String("number"),
	})

	vpc := myconstructs.NewMyAwsVpc(this, jsii.String("vpc"), &myconstructs.awsVpcProps{
		name: jsii.String("vpcName"),
		publicSubnets: [jsii.String("10.0.1.0/24"), jsii.String("10.0.2.0/24")]
	})

	myconstructs.NewEksCluster(this, jsii.String("EksModule"), &myconstructs.eksProps{
