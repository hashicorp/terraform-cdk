...
You can configure your CDK for Terraform (CDKTF) remote backend to be [Terraform Cloud](/cloud-docs), another Terraform [supported backend](#supported-backends), or a custom location.
...
- [local](/language/settings/backends/enhanced/local)
  ...
  ```
- [artifactory](/language/settings/backends/standard/artifactory)
  ```typescript
...
- [cos](/language/settings/backends/standard/cos)
  ...
  ```
- [etcd](/language/settings/backends/standard/etcd)
  ```typescript
...
- [gcs](/language/settings/backends/standard/gcs)
  ...
  ```
- [http](/language/settings/backends/standard/http)
  ```typescript
...
- [manta](/language/settings/backends/standard/manta)
  ...
  ```
- [oss](/language/settings/backends/standard/oss)
  ```typescript
  new OssBackend(stack, {...});
  ```
- [pg](/language/settings/backends/standard/pg)
  ```typescript
  new PgBackend(stack, {...});
  ```
- [s3](/language/settings/backends/standard/s3)
  ...
  new S3Backend(stack, {...});
  ```
- [swift](/language/settings/backends/standard/swift)
  ```typescript
