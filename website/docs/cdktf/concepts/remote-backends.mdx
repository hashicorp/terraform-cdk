...
The example below uses the `TerraformBackend` subclass `RemoteBackend`.
...
from cdktf import App, RemoteBackend, TerraformStack, TerraformOutput
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	cdktf.NewRemoteBackend(this, &remoteBackendProps{
		hostname: jsii.String("app.terraform.io"),
		organization: jsii.String("company"),
		workspaces: map[string]*string{
			"name": jsii.String("my-app-prod"),
		},
	})
...
App app = new App();
MyStack stack = new MyStack(app, "hello-terraform");
RemoteBackend.Builder.create(stack)
        .hostname("app.terraform.io")
        .organization("company")
        .workspaces(Map.of(
                "name", "my-app-prod"))
...
App app = new App();
MyStack stack = new MyStack(app, "hello-terraform");
new RemoteBackend(stack, new RemoteBackendProps {
    Hostname = "app.terraform.io",
    Organization = "company",
    Workspaces = new Dictionary<string, string> {
        { "name", "my-app-prod" }
...
app := cdktf.NewApp()
stack := NewMyStack(app, jsii.String("hello-terraform"))
cdktf.NewRemoteBackend(stack, &remoteBackendProps{
	hostname: jsii.String("app.terraform.io"),
	organization: jsii.String("company"),
	workspaces: map[string]*string{
		"name": jsii.String("my-app-prod"),
