...
import com.mycompany.app.KubernetesWebAppDeployment;
...
import "github.com/myorg/myproject/generated/hashicorp/kubernetes"
...
import software.constructs.Construct;
import com.hashicorp.cdktf.TerraformStack;
import com.mycompany.app.S3Bucket;
...
func newPublicS3Bucket(scope construct, name *string) *publicS3Bucket {
	...
	// This bucket is in a different scope than the buckets
	// defined in `MyStack` below. Therefore, it does not need a unique name.
	this.bucket = myconstructs.NewS3Bucket(this, jsii.String("bucket"), map[string]interface{}{
		"bucketPrefix": name,
