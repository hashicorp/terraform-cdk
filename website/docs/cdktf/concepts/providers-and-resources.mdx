...
func newMyStack(scope construct, id *string) *myStack {
	...
	aws.Ec2.NewInstance(this, jsii.String("Hello"), &instanceConfig{
...
func NewHelloTerra(scope construct, id *string) *HelloTerra {
	...
	aws.Dynamodb.NewDynamodbTable(this, jsii.String("Hello"), &dynamodbTableConfig{
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	app := "my-app"
	exampleNamespace := kubernetes.NewNamespace(this, jsii.String("tf-cdk-example"), &namespaceConfig{
		metadata: &namespaceMetadata{
			name: jsii.String("tf-cdk-example"),
		},
	})

	kubernetes.NewDeployment(this, jsii.String("nginx-deployment"), &deploymentConfig{
		metadata: &deploymentMetadata{
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	table := aws.Dynamodb.NewDynamodbTable(this, jsii.String("Hello"), &dynamodbTableConfig{
		name: tableName,
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	topic := aws.Sns.NewSnsTopic(this, jsii.String("Topic"), &snsTopicConfig{
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	aws.NewAwsProvider(this, jsii.String("aws"))
	ports := cdktf.NewTerraformVariable(this, jsii.String("ports"), &terraformVariableConfig{
	...
	sg := aws.Vpc.NewSecurityGroup(this, jsii.String("sec1grp"), &securityGroupConfig{
...
func NewMyStack(scope construct, id *string) *MyStack {
	...
	aws.Vpc.NewSecurityGroup(this, jsii.String("sec1grp"), &securityGroupConfig{
		name: jsii.String("security1"),
		vpcId: jsii.String("vpcs"),
		egress: []interface{}{
			&securityGroupEgress{
