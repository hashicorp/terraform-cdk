...
description: >-
  Use the CDKTF core library with generated provider bindings to write your CDKTF program. Get API reference in TypeScript, Python, Java, CSharp, and Go.
---
...
In addition to the core library, you can use [generated provider bindings](/cdktf/concepts/providers-and-resources) and [Constructs](https://constructs.dev/search?q=&cdk=cdktf&offset=0) in CDKTF applications.
