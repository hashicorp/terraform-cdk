...
- `toNotHaveResourceWithProperties`: Checks if a certain resource exists without any of the properties passed
...
- `toNotHaveDataSourceWithProperties`: Checks if a certain data source exists without any of the properties passed
...
- `toNotHaveProviderWithProperties`: Checks if a certain provider exists without any of the properties passed
...
describe("Unit testing using assertions", () => {
  ...
  it("should not have Container resource with property command", () => {
    expect(
      Testing.synthScope((scope) => {
...
class TestApplication:
  ...
  def test_should_not_have_property_command(self):
...
public class TestApplication {
  ...
  @Test
  void shouldNotHavePropertyCommand() {
...
namespace MyCompany.MyApp{
  public class TestApplication{
    ...
    [Fact]
    public void shouldNotHaveContainerWithProperties(){
