...
You can also search for the resource name, Terraform, and the error to find similar issues in user forums or look at the provider's Github repository for related issues. 
