...
from jsii_workbench.core import MyResource
...
import workbench.jsii.danielmschmidt.com.MyResource;
...
func newMyStack(scope construct, name *string) *myStack {
	...
	adminPassword := cdktf.NewTerraformVariable(this, jsii.String("adminPassword"), &terraformVariableConfig{
		type: jsii.String("string"),
		description: jsii.String("Admin password for the instance"),
		sensitive: jsii.Boolean(true),
	})

	jsiiworkbench.NewMyResource(this, jsii.String("hello"), &myResourceProps{
		adminPassword: adminPassword.value,
	})
	return this
}
...
new Blog(app, "ecommerce-development", {
  vpcId: devNetworking.vpcId,
  subnets: devNetworking.subnets,
  region: "us-west-1",
});
...
new Blog(app, "ecommerce-staging", {
  vpcId: stageNetworking.vpcId,
  subnets: stageNetworking.subnets,
  region: "us-west-1",
});
...
from jsii_workbench.core import NetworkingStack, Ecommerce, Blog
...
Blog(app, "ecommerce-development",
    vpc_id=dev_networking.vpc_id,
    subnets=dev_networking.subnets,
    region="us-west-1"
)
...
```java
import com.hashicorp.cdktf.App;
import workbench.jsii.danielmschmidt.com.NetworkingStack;
import workbench.jsii.danielmschmidt.com.Ecommerce;
import workbench.jsii.danielmschmidt.com.Blog;
...
Ecommerce.Builder.create(app, "ecommerce-development")
        ...
        .region("us-west-1")
        .build();
Blog.Builder.create(app, "ecommerce-development")
        .vpcId(devNetworking.getVpcId())
        .subnets(devNetworking.getSubnets())
        .region("us-west-1")
        .build();
...
Ecommerce.Builder.create(app, "ecommerce-staging-eu")
        ...
        .build();
Blog.Builder.create(app, "ecommerce-staging")
        .vpcId(stageNetworking.getVpcId())
        .subnets(stageNetworking.getSubnets())
        .region("us-west-1")
        .build();
...
new Blog(app, "ecommerce-development", new BlogProps {
    VpcId = devNetworking.VpcId,
    Subnets = devNetworking.Subnets,
    Region = "us-west-1"
});
...
new Blog(app, "ecommerce-staging", new BlogProps {
    VpcId = stageNetworking.VpcId,
    Subnets = stageNetworking.Subnets,
    Region = "us-west-1"
});
...
app := cdktf.NewApp()
devNetworking := jsiiworkbench.NewNetworkingStack(app, jsii.String("networking-development"), map[string]interface{}{
})

// A single region is enough to create a development environment for each product.
// A single region is enough to create a development environment for each product.
jsiiworkbench.NewEcommerce(app, jsii.String("ecommerce-development"), &ecommerceProps{
	vpcId: devNetworking.vpcId,
	subnets: devNetworking.subnets,
	region: jsii.String("us-west-1"),
})
jsiiworkbench.NewBlog(app, jsii.String("ecommerce-development"), &blogProps{
	vpcId: devNetworking.vpcId,
	subnets: devNetworking.subnets,
	region: jsii.String("us-west-1"),
})
...
// Staging environments require two ecommerce stacks in different regions
// to test the high availability features of the infrastructure.
stageNetworking := jsiiworkbench.NewNetworkingStack(app, jsii.String("networking-staging"), map[string]interface{}{
})
ecommerceStaging := jsiiworkbench.NewEcommerce(app, jsii.String("ecommerce-staging-us"), &ecommerceProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("us-west-1"),
})
jsiiworkbench.NewEcommerce(app, jsii.String("ecommerce-staging-eu"), &ecommerceProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("eu-central-1"),
	databaseReplicationMaster: ecommerceStaging.databaseReplicationMaster,
})
jsiiworkbench.NewBlog(app, jsii.String("ecommerce-staging"), &blogProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("us-west-1"),
})
...
func NewMyS3Bucket(scope construct, id *string, s3Options s3BucketConfig) *MyS3Bucket {
	...
	aws.S3.NewS3Bucket(this, jsii.String("MyBucket"), &s3BucketConfig{
		(SpreadAssignment ...s3Options
				*s3Options),
		bucket: this.getBucketName(),
