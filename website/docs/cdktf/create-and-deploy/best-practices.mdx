...
func newMyStack(scope construct, name *string) *myStack {
	...
	myconstructs.NewMyResource(this, jsii.String("hello"), &myResourceProps{
		adminPassword: adminPassword.value,
	})
	return this
}
...
// A single region is enough to create a development environment for each product.
myconstructs.NewEcommerce(app, jsii.String("ecommerce-development"), &ecommerceProps{
	vpcId: devNetworking.vpcId,
	subnets: devNetworking.subnets,
	region: jsii.String("us-west-1"),
})
myconstructs.NewBlog(app, jsii.String("ecommerce-development"), &blogProps{
	vpcId: devNetworking.vpcId,
	subnets: devNetworking.subnets,
	region: jsii.String("us-west-1"),
})
...
ecommerceStaging := myconstructs.NewEcommerce(app, jsii.String("ecommerce-staging-us"), &ecommerceProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("us-west-1"),
})
myconstructs.NewEcommerce(app, jsii.String("ecommerce-staging-eu"), &ecommerceProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("eu-central-1"),
	databaseReplicationMaster: ecommerceStaging.databaseReplicationMaster,
})
myconstructs.NewBlog(app, jsii.String("ecommerce-staging"), &blogProps{
	vpcId: stageNetworking.vpcId,
	subnets: stageNetworking.subnets,
	region: jsii.String("us-west-1"),
})
