...
| TF_TOKEN_app_terraform_io      | The token CDKTF should use to authenticate with Terrafrom Cloud. Must be set to a valid [Terraform Cloud API token](/terraform/cloud-docs/users-teams-organizations/api-tokens). In case of TFE app_terraform_io would be your hostname. |                              |
