...
Next, run `cdktf init` without passing the `--local` flag.
This creates a new template CDKTF project for your chosen programming language.
It will be the basis for a new application with the necessary file structure for you to start defining infrastructure.
Choose a project language and provide a project name and description.
Select a Terraform Cloud organization and a name for your workspace and let CDKTF CLI create it for you.
Next you can choose whether to send crash reports to the CDKTF team and select the providers you want to use.
