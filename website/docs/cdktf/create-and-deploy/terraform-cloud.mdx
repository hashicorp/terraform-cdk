...
By default, the workspace is set to Local Execution mode, which means Terraform continues to run on your local machine. If you want Terraform to run remotely, you need to set the workspace to Remote Execution mode.
...
class MyStack extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new RemoteBackend(this, {
      // Only required for self-hosted Terraform Enterprise instances. Defaults to "app.terraform.io".
...
3. Add variables that you declared in your CDKTF application to your Terraform Cloud workspace. Refer to [Add a Variable](/cloud-docs/workspaces/variables/managing-variables#add-a-variable) for details. This lets Terraform can access the value during operations.
