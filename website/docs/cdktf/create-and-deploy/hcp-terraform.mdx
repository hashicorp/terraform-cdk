---
page_title: Connect to HCP Terraform or Terraform Enterprise
description: >-
  Use HCP Terraform or Terraform Enterprise to to store your CDK for Terraform
  project state remotely, manage secrets, and collaborate with team members.
---

# Connect CDK for Terraform to HCP Terraform or Terraform Enterprise
