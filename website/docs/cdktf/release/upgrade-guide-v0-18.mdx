---
page_title: Upgrade to CDKTF version 0.18
description: >-
  Learn how to upgrade to CDK for Terraform version 0.18. Python performance
  improvements disable root-level provider imports.
---

# Upgrade to CDK for Terraform version 0.18
