---
page_title: Upgrade to CDKTF version 0.6
description: >-
  Learn how to upgrade to CDK for Terraform version 0.6. Version 0.6 uses
  constructs version 10. Understand the API changes and learn how to migrate
  your projects.
---

# Upgrade to CDK for Terraform version 0.6
