---
page_title: Upgrade to CDKTF version 0.15
description: >-
  Learn how to upgrade to CDK for Terraform version 0.15. Minimum version of
  Terraform increased to 1.2, some interfaces and classes renamed for C#, Java,
  and Go.
---

# Upgrade to CDKTF version 0.15
