...
We ship CDK for Terraform releases regularly. Recent releases are listed below. Our [CHANGELOG on github](https://github.com/hashicorp/terraform-cdk/blob/main/CHANGELOG.md) contains details about bug fixes, new features, and deprecations.
