---
page_title: Upgrade to CDKTF version 0.7
description: >-
  Learn how to upgrade to CDK for Terraform version 0.7. Update your import
  statements for the AWS provider and learn to migrate your projects.
---

# Upgrade to CDK for Terraform version 0.7
