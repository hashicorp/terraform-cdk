...
description: >-
  If you use the AWS Provider, you must adjust your import statements. Understand the API changes and learn how to migrate your projects.
---

# Upgrading to CDK for Terraform Version 0.7

If you use the AWS Provider, you must adjust your import statements. Learn about the API changes and how to migrate your projects.
