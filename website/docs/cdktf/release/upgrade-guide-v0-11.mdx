---
page_title: Upgrade to CDKTF version 0.11
description: >-
  Learn how to upgrade to CDK for Terraform version 0.11. Changes to how
  assignable list and map properties are accessed after resource construction.
---

# Upgrade to CDK for Terraform version 0.11
