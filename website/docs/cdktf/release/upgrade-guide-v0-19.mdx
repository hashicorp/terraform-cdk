---
page_title: Upgrade to CDKTF version 0.19
description: >-
  Learn how to upgrade to CDK for Terraform version 0.19. Potential provider
  naming collision with new instance function `moveTo`.
---

# Upgrade to CDK for Terraform version 0.19
