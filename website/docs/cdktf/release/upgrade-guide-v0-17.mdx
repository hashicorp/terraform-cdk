---
page_title: Upgrade to CDKTF version 0.17
description: >-
  Learn how to upgrade to CDK for Terraform version 0.17. Breaking changes to
  AWS Quicksight resources and removal of deprecated feature flags.
---

# Upgrade to CDK for Terraform version 0.17
