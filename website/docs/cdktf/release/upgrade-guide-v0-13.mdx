---
page_title: Upgrade to CDKTF version 0.13
description: >-
  Learn how to upgrade to CDK for Terraform version 0.13. Namespaces for
  generated providers.
---

# Upgrade to CDK for Terraform version 0.13
