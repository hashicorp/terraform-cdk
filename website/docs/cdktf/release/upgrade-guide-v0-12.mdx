---
page_title: Upgrade to CDKTF version 0.12
description: >-
  Learn how to upgrade to CDK for Terraform version 0.12. Simplified recursive
  attribute types to have shorter names.
---

# Upgrade to CDK for Terraform version 0.12
