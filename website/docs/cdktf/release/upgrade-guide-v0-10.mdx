---
page_title: Upgrade to CDKTF version 0.10
description: >-
  Learn how to upgrade to CDK for Terraform version 0.10. Changes to how lists
  of computed attributes work to allow referencing the whole list.
---

# Upgrade to CDK for Terraform version 0.10
