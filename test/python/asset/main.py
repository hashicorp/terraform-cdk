...
class MyStack(TerraformStack):
    def __init__(self, scope: Construct, ns: str):
        ...
        fixture = TerraformAsset(self, 'fixture', path=os.path.abspath("./fixture.txt"), asset_hash="hash")
        fixtures = TerraformAsset(self, 'fixtures', path=os.path.abspath("./fixtures"), asset_hash="hash", type=AssetType.ARCHIVE)
