...
import { TerraformAny, TerraformAnyAttribute, TerraformStringAttribute, TerraformNumberAttribute, TerraformStringListAttribute, TerraformAnyListAttribute, TerraformBooleanAttribute } from "./attributes";
import { ITerraformAddressable } from "./terraform-addressable";

export class TerraformLocal extends TerraformElement implements ITerraformAddressable {
