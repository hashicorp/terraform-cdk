...
export class TerraformDynamicAttribute extends TerraformAttribute {
    ...
    public static construct(parent: ITerraformAddressable, terraformAttribute: string, value: TerraformDynamic | undefined) {
        if (!(value instanceof TerraformDynamicAttribute)) {
            ...
            return new TerraformDynamicAttribute(parent, terraformAttribute, value.internalValue, { nested: value });
        }
    }
