...
export class TerraformStringMapAttribute extends TerraformMapAttribute {
    ...
    public static construct(parent: ITerraformAddressable, terraformAttribute: string, value: TerraformStringMap | undefined) {
        if (!(value instanceof TerraformStringMapAttribute)) {
            ...
            return new TerraformStringMapAttribute(parent, terraformAttribute, value.internalValue, { nested: value });
        }
    }
