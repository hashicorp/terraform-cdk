...
export class TerraformBooleanAttribute extends TerraformAttribute {
    ...
    public static construct(parent: ITerraformAddressable, terraformAttribute: string, value: TerraformBoolean | undefined) {
        if (typeof(value) === 'boolean' || value === undefined) {
            ...
            return new TerraformBooleanAttribute(parent, terraformAttribute, value.internalValue, { nested: value });
        }
    }
