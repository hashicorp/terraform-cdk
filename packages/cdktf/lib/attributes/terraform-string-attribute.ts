...
export class TerraformStringAttribute extends TerraformAttribute {
    ...
    public static construct(parent: ITerraformAddressable, terraformAttribute: string, value: TerraformString | undefined) {
        if (typeof(value) === 'string' || value === undefined) {
            ...
            return new TerraformStringAttribute(parent, terraformAttribute, value.internalValue, { nested: value });
        }
    }
