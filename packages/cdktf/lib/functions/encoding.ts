...
export class Encoding {
   ...
   * @param {string} value
   */
  public static base64decode = terraformFunction("base64decode", [stringValue]);
   ...
   * @param {string} value
   */
  public static base64encode = terraformFunction("base64encode", [stringValue]);
   ...
   * @param {string} value
   */
  public static base64gzip = terraformFunction("base64gzip", [stringValue]);
   ...
   * @param {string} value
   */
  public static csvdecode = terraformFunction("csvdecode", [stringValue]);
   ...
   * @param {string} value
   */
  public static jsondecode = terraformFunction("jsondecode", [stringValue]);
   ...
   * @param {any} value
   */
  public static jsonencode = terraformFunction("jsonencode", [anyValue]);
   ...
   */
  public static textdecodebase64 = terraformFunction("textdecodebase64", [
    stringValue,
    stringValue,
  ]);
   ...
   * @param {string} encoding_name
   */
  public static textencodebase64 = terraformFunction("textencodebase64", [
    stringValue,
    stringValue,
  ]);
   ...
   * @param {string} value
   */
  public static urlencode = terraformFunction("urlencode", [stringValue]);

  /**
   * {@link https://www.terraform.io/docs/language/functions/yamldecode.html yamldecode} applies URL encoding to a given string.
   * @param {string} value
   */
  public static yamldecode = terraformFunction("yamldecode", [stringValue]);
   ...
   * @param {any} value
   */
  public static yamlencode = terraformFunction("yamlencode", [anyValue]);
}
