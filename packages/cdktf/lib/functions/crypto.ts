...
export class Crypto {
   ...
   * @param {string} value
   */
  public static base64sha256 = terraformFunction("base64sha256", [stringValue]);
   ...
   * @param {string} value
   */
  public static base64sha512 = terraformFunction("base64sha512", [stringValue]);
   ...
   */
  public static bcrypt = terraformFunction("bcrypt", listOf(anyValue));
   ...
   * @param {string} value
   */
  public static filebase64sha256 = terraformFunction("filebase64sha256", [
    stringValue,
  ]);
   ...
   * @param {string} value
   */
  public static filebase64sha512 = terraformFunction("filebase64sha512", [
    stringValue,
  ]);
   ...
   * @param {string} value
   */
  public static filemd5 = terraformFunction("filemd5", [stringValue]);
   ...
   * @param {string} value
   */
  public static filesha1 = terraformFunction("filesha1", [stringValue]);
   ...
   * @param {string} value
   */
  public static filesha256 = terraformFunction("filesha256", [stringValue]);
   ...
   * @param {string} value
   */
  public static filesha512 = terraformFunction("filesha512", [stringValue]);
   ...
   * @param {string} value
   */
  public static md5 = terraformFunction("md5", [stringValue]);
   ...
   */
  public static rsadecrypt = terraformFunction("rsadecrypt", [stringValue]);
   ...
   * @param {string} value
   */
  public static sha1 = terraformFunction("sha1", [stringValue]);
   ...
   * @param {string} value
   */
  public static sha256 = terraformFunction("sha256", [stringValue]);
   ...
   * @param {string} name
   */
  public static uuidv5 = terraformFunction("uuidv5", [
    stringValue,
    stringValue,
  ]);
}
