...
export const Numeric = {
   ...
   * @param {number} value
   */
  abs: terraformFunction("abs", [numericValue]),
   ...
   * @param {number} value
   */
  ceil: terraformFunction("ceil", [numericValue]),
   ...
   * @param {number} value
   */
  floor: terraformFunction("floor", [numericValue]),
   ...
   * @param {number} base
   */
  log: terraformFunction("log", [numericValue, numericValue]),
   ...
   * @param {...number} values
   */
  max: terraformFunction("max", listOf(numericValue)),
   ...
   * @param {...number} values
   */
  min: terraformFunction("min", listOf(numericValue)),
   ...
   * @param {number} base
   */
  parseInt: terraformFunction("parseInt", [stringValue, numericValue]),
   ...
   * @param {number} power
   */
  pow: terraformFunction("pow", [numericValue, numericValue]),
   ...
   * @param {number} value
   */
  signum: terraformFunction("signum", [numericValue]),
};
