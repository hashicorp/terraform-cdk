...
export class Collection {
   ...
   * @param {Array} value
   */
  public static alltrue = terraformFunction("alltrue", [listOf(anyValue)]);
   ...
   * @param {Array} value
   */
  public static anytrue = terraformFunction("anytrue", [listOf(anyValue)]);
   ...
   */
  public static chunklist = terraformFunction("chunklist", [
    listOf(anyValue),
    numericValue,
  ]);
   ...
   * @param {...any} value
   */
  public static coalesce = terraformFunction("coalesce", listOf(anyValue));
   ...
   * @param {...Array} value
   */
  public static coalescelist = terraformFunction(
    "coalescelist",
    listOf(anyValue)
  );
   ...
   * @param {Array} value
   */
  public static compact = terraformFunction("compact", [listOf(anyValue)]);
   ...
   * @param {...Array} value
   */
  public static concat = terraformFunction("concat", listOf(anyValue));
   ...
   * @param {any} value
   */
  public static contains = terraformFunction("contains", [
    listOf(anyValue),
    anyValue,
  ]);
   ...
   * @param {Array} list
   */
  public static distinct = terraformFunction("distinct", [listOf(anyValue)]);
   ...
   * @param {number} index
   */
  public static element = terraformFunction("element", [
    listOf(anyValue),
    numericValue,
  ]);
   ...
   * @param {Array} list
   */
  public static flatten = terraformFunction("flatten", [listOf(anyValue)]);
   ...
   * @param {any} value
   */
  public static index = terraformFunction("index", [
    listOf(anyValue),
    anyValue,
  ]);
   ...
   * @param {Object} map
   */
  public static keys = terraformFunction("keys", [mapValue]);
   ...
   */
  public static _length = terraformFunction("length", [anyValue]);
   ...
   * @param {any} default
   */
  public static lookup = terraformFunction("lookup", [
    anyValue,
    anyValue,
    anyValue,
  ]);
   ...
   */
  public static matchkeys = terraformFunction("matchkeys", [
    anyValue,
    anyValue,
    anyValue,
  ]);
   ...
   */
  public static merge = terraformFunction("merge", [listOf(anyValue)]);
   ...
   * @param {Array} list
   */
  public static one = terraformFunction("one", listOf(anyValue));
   ...
   * @param {number=1} step
   */
  public static range = terraformFunction("range", listOf(anyValue));
   ...
   * @param {Array} values
   */
  public static reverse = terraformFunction("reverse", [listOf(anyValue)]);
   ...
   * @param {...Array} values
   */
  public static setintersection = terraformFunction(
    "setintersection",
    listOf(anyValue)
  );
   ...
   * @param {...Array} values
   */
  public static setproduct = terraformFunction("setproduct", listOf(anyValue));
   ...
   */
  public static setsubtract = terraformFunction("setsubtract", [
    listOf(anyValue),
    listOf(anyValue),
  ]);
   ...
   * @param {...Array} values
   */
  public static setunion = terraformFunction("setunion", listOf(anyValue));
   ...
   */
  public static slice = terraformFunction("slice", [
    listOf(anyValue),
    numericValue,
    numericValue,
  ]);
   ...
   * @param {Array} list
   */
  public static sort = terraformFunction("sort", [listOf(anyValue)]);
   ...
   * @param {Array} list
   */
  public static sum = terraformFunction("sum", [listOf(anyValue)]);
   ...
   * @param {Object} value
   */
  public static transpose = terraformFunction("transpose", [mapValue]);
   ...
   * @param {Object} value
   */
  public static values = terraformFunction("values", [mapValue]);
   ...
   * @param {Array} valueslist
   */
  public static zipmap = terraformFunction("zipmap", [mapValue]);
}
