export const CUSTOM_DEFAULTS: { [fullName: string]: any } = {
    ...
    "azurerm.eventhub_namespace.network_rulesets.trusted_service_access_enabled": null,
    "azurerm.eventhub_namespace.network_rulesets.virtual_network_rule": null,
    "azurerm.eventhub_namespace.network_rulesets.virtual_network_rule.subnet_id": null,
    "azurerm.eventhub_namespace.network_rulesets.virtual_network_rule.ignore_missing_virtual_network_service_endpoint": null,
    ...
    "azurerm.mssql_database.extended_auditing_policy.storage_account_access_key": null,
    "azurerm.mssql_database.extended_auditing_policy.storage_endpoint": null,
    "azurerm.mssql_database.extended_auditing_policy.storage_account_access_key_is_secondary": null,
    "azurerm.mssql_database.extended_auditing_policy.retention_in_days": null,

    "azurerm.mssql_server.extended_auditing_policy.storage_account_access_key": null,
    "azurerm.mssql_server.extended_auditing_policy.storage_endpoint": null,
    "azurerm.mssql_server.extended_auditing_policy.storage_account_access_key_is_secondary": null,
    ...
    "azurerm.site_recovery_replicated_vm.managed_disk.staging_storage_account_id": null,
    "azurerm.site_recovery_replicated_vm.managed_disk.target_resource_group_id": null,
    "azurerm.site_recovery_replicated_vm.managed_disk.target_disk_type": null,
    "azurerm.site_recovery_replicated_vm.managed_disk.target_replica_disk_type": null,
    "azurerm.site_recovery_replicated_vm.network_interface.source_network_interface_id": null,
    "azurerm.site_recovery_replicated_vm.network_interface.target_static_ip": null,
    "azurerm.site_recovery_replicated_vm.network_interface.target_subnet_name": null,
    ...
    "azurerm.network_security_group.security_rule.destination_address_prefix": null,
    "azurerm.network_security_group.security_rule.destination_address_prefixes": null,
    "azurerm.network_security_group.security_rule.destination_application_security_group_ids": null,
    "azurerm.network_security_group.security_rule.source_application_security_group_ids": null,
    ...
    "azurerm.batch_pool.container_configuration.container_registries.registry_server": null,
    "azurerm.batch_pool.container_configuration.container_registries.user_name": null,
    "azurerm.batch_pool.container_configuration.container_registries.password": null,
