...
*/
export declare class DataAwsccIotDimensions extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIotDimensionsConfig);
    get id(): string;
    get ids(): string[];
