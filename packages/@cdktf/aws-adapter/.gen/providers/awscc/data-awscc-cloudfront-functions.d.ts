...
*/
export declare class DataAwsccCloudfrontFunctions extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccCloudfrontFunctionsConfig);
    get id(): string;
    get ids(): string[];
