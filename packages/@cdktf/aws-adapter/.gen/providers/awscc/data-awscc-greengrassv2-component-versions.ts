// https://www.terraform.io/docs/providers/awscc/d/greengrassv2_component_versions.html
...
*/
export class DataAwsccGreengrassv2ComponentVersions extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_greengrassv2_component_versions";
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsccGreengrassv2ComponentVersionsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'awscc_greengrassv2_component_versions',
