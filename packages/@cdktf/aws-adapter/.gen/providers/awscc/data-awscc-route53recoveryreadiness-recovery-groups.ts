// https://www.terraform.io/docs/providers/awscc/d/route53recoveryreadiness_recovery_groups.html
...
*/
export class DataAwsccRoute53RecoveryreadinessRecoveryGroups extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_route53recoveryreadiness_recovery_groups";
