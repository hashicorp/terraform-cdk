...
*/
export declare class DataAwsccCodestarconnectionsConnections extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccCodestarconnectionsConnectionsConfig);
    get id(): string;
    get ids(): string[];
