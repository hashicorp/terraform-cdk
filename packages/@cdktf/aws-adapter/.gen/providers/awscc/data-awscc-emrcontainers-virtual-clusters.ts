...
*/
export class DataAwsccEmrcontainersVirtualClusters extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_emrcontainers_virtual_clusters";
