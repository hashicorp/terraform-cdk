// https://www.terraform.io/docs/providers/awscc/d/resourcegroups_groups.html
...
*/
export class DataAwsccResourcegroupsGroups extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_resourcegroups_groups";
