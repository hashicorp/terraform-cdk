...
*/
export class DataAwsccImagebuilderInfrastructureConfigurations extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_imagebuilder_infrastructure_configurations";
