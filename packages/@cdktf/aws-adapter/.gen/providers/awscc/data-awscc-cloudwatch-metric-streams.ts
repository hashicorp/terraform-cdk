// https://www.terraform.io/docs/providers/awscc/d/cloudwatch_metric_streams.html
...
*/
export class DataAwsccCloudwatchMetricStreams extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_cloudwatch_metric_streams";
