...
*/
export declare class DataAwsccBudgetsBudgetsActions extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccBudgetsBudgetsActionsConfig);
    get id(): string;
    get ids(): string[];
