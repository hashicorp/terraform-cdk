// https://www.terraform.io/docs/providers/awscc/d/config_stored_queries.html
...
*/
export class DataAwsccConfigStoredQueries extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_config_stored_queries";
