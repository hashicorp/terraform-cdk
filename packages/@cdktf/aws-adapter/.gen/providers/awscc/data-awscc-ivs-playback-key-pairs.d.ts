...
*/
export declare class DataAwsccIvsPlaybackKeyPairs extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIvsPlaybackKeyPairsConfig);
    get id(): string;
    get ids(): string[];
