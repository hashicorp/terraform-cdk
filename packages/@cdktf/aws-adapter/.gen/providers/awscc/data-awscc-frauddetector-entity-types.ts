// https://www.terraform.io/docs/providers/awscc/d/frauddetector_entity_types.html
...
*/
export class DataAwsccFrauddetectorEntityTypes extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_frauddetector_entity_types";
