...
*/
export declare class DataAwsccKinesisStreams extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccKinesisStreamsConfig);
    get id(): string;
    get ids(): string[];
