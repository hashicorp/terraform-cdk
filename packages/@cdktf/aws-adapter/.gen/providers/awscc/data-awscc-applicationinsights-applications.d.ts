...
*/
export declare class DataAwsccApplicationinsightsApplications extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccApplicationinsightsApplicationsConfig);
    get id(): string;
    get ids(): string[];
