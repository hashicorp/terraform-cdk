...
*/
export declare class DataAwsccCloudformationPublicTypeVersions extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccCloudformationPublicTypeVersionsConfig);
    get id(): string;
    get ids(): string[];
