...
*/
export declare class DataAwsccFisExperimentTemplates extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccFisExperimentTemplatesConfig);
    get id(): string;
    get ids(): string[];
