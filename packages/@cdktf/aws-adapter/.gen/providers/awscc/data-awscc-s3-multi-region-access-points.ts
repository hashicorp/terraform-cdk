// https://www.terraform.io/docs/providers/awscc/d/s3_multi_region_access_points.html
...
*/
export class DataAwsccS3MultiRegionAccessPoints extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_s3_multi_region_access_points";
