// https://www.terraform.io/docs/providers/awscc/d/lookoutmetrics_anomaly_detectors.html
...
*/
export class DataAwsccLookoutmetricsAnomalyDetectors extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_lookoutmetrics_anomaly_detectors";
