// https://www.terraform.io/docs/providers/awscc/d/ecs_capacity_providers.html
...
*/
export class DataAwsccEcsCapacityProviders extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_ecs_capacity_providers";
