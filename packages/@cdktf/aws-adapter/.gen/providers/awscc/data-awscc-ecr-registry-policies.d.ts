...
*/
export declare class DataAwsccEcrRegistryPolicies extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccEcrRegistryPoliciesConfig);
    get id(): string;
    get ids(): string[];
