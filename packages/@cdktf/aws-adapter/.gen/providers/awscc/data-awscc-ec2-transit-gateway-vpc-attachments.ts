// https://www.terraform.io/docs/providers/awscc/d/ec2_transit_gateway_vpc_attachments.html
...
*/
export class DataAwsccEc2TransitGatewayVpcAttachments extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_ec2_transit_gateway_vpc_attachments";
