...
*/
export declare class DataAwsccIoteventsDetectorModels extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIoteventsDetectorModelsConfig);
    get id(): string;
    get ids(): string[];
