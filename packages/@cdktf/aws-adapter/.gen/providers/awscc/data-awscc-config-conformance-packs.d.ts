...
*/
export declare class DataAwsccConfigConformancePacks extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccConfigConformancePacksConfig);
    get id(): string;
    get ids(): string[];
