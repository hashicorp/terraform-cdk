...
*/
export declare class DataAwsccDatasyncLocationNfsPlural extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccDatasyncLocationNfsPluralConfig);
    get id(): string;
    get ids(): string[];
