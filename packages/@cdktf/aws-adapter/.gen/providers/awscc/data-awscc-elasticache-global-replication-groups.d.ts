...
*/
export declare class DataAwsccElasticacheGlobalReplicationGroups extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccElasticacheGlobalReplicationGroupsConfig);
    get id(): string;
    get ids(): string[];
