...
*/
export declare class DataAwsccImagebuilderContainerRecipes extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccImagebuilderContainerRecipesConfig);
    get id(): string;
    get ids(): string[];
