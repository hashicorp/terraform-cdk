...
*/
export declare class DataAwsccSesConfigurationSets extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccSesConfigurationSetsConfig);
    get id(): string;
    get ids(): string[];
