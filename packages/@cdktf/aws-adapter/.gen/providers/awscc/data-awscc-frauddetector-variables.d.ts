...
*/
export declare class DataAwsccFrauddetectorVariables extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccFrauddetectorVariablesConfig);
    get id(): string;
    get ids(): string[];
