// https://www.terraform.io/docs/providers/awscc/d/route53recoveryreadiness_cells.html
...
*/
export class DataAwsccRoute53RecoveryreadinessCells extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_route53recoveryreadiness_cells";
