// https://www.terraform.io/docs/providers/awscc/d/ec2_transit_gateways.html
...
*/
export class DataAwsccEc2TransitGateways extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_ec2_transit_gateways";
