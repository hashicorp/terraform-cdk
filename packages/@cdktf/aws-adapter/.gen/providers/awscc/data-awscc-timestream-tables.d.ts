...
*/
export declare class DataAwsccTimestreamTables extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccTimestreamTablesConfig);
    get id(): string;
    get ids(): string[];
