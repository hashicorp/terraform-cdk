// https://www.terraform.io/docs/providers/awscc/d/ssm_resource_data_syncs.html
...
*/
export class DataAwsccSsmResourceDataSyncs extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_ssm_resource_data_syncs";
