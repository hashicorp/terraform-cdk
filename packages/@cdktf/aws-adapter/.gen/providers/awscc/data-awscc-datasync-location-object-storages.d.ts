...
*/
export declare class DataAwsccDatasyncLocationObjectStorages extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccDatasyncLocationObjectStoragesConfig);
    get id(): string;
    get ids(): string[];
