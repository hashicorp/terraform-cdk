...
*/
export declare class DataAwsccMediapackageChannels extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccMediapackageChannelsConfig);
    get id(): string;
    get ids(): string[];
