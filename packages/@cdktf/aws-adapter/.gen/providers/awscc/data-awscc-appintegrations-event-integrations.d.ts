...
*/
export declare class DataAwsccAppintegrationsEventIntegrations extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccAppintegrationsEventIntegrationsConfig);
    get id(): string;
    get ids(): string[];
