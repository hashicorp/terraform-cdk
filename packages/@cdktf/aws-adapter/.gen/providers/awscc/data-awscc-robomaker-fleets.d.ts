...
*/
export declare class DataAwsccRobomakerFleets extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccRobomakerFleetsConfig);
    get id(): string;
    get ids(): string[];
