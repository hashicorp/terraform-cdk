...
*/
export declare class DataAwsccIotCertificates extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIotCertificatesConfig);
    get id(): string;
    get ids(): string[];
