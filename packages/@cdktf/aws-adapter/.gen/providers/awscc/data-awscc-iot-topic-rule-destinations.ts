// https://www.terraform.io/docs/providers/awscc/d/iot_topic_rule_destinations.html
...
*/
export class DataAwsccIotTopicRuleDestinations extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_iot_topic_rule_destinations";
