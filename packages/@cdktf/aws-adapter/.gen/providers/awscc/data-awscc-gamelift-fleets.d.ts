...
*/
export declare class DataAwsccGameliftFleets extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccGameliftFleetsConfig);
    get id(): string;
    get ids(): string[];
