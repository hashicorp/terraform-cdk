// https://www.terraform.io/docs/providers/awscc/d/route53_hosted_zones.html
...
*/
export class DataAwsccRoute53HostedZones extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_route53_hosted_zones";
