// https://www.terraform.io/docs/providers/awscc/d/config_organization_conformance_packs.html
...
*/
export class DataAwsccConfigOrganizationConformancePacks extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_config_organization_conformance_packs";
