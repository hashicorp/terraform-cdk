...
*/
export declare class DataAwsccElasticacheUserGroups extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccElasticacheUserGroupsConfig);
    get id(): string;
    get ids(): string[];
