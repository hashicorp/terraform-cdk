...
*/
export declare class DataAwsccSagemakerImages extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccSagemakerImagesConfig);
    get id(): string;
    get ids(): string[];
