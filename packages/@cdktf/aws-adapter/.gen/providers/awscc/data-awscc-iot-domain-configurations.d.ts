...
export interface DataAwsccIotDomainConfigurationsConfig extends cdktf.TerraformMetaArguments {
}
/**
...
*/
export declare class DataAwsccIotDomainConfigurations extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIotDomainConfigurationsConfig);
    get id(): string;
    get ids(): string[];
