...
*/
export declare class DataAwsccIamVirtualMfaDevices extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccIamVirtualMfaDevicesConfig);
    get id(): string;
    get ids(): string[];
