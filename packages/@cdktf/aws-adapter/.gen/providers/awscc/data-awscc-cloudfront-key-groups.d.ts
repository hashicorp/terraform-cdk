...
*/
export declare class DataAwsccCloudfrontKeyGroups extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccCloudfrontKeyGroupsConfig);
    get id(): string;
    get ids(): string[];
