...
*/
export declare class DataAwsccChatbotSlackChannelConfigurations extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccChatbotSlackChannelConfigurationsConfig);
    get id(): string;
    get ids(): string[];
