...
*/
export declare class DataAwsccCloudformationStackSets extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataAwsccCloudformationStackSetsConfig);
    get id(): string;
    get ids(): string[];
