// https://www.terraform.io/docs/providers/awscc/d/iotwireless_device_profiles.html
...
*/
export class DataAwsccIotwirelessDeviceProfiles extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "awscc_iotwireless_device_profiles";
